...
This mod is a collection of several projects, each of which would normally have its own thread and installation. However, it made far more sense for us to code them all together as one giant mod. So that's what we did.

A few notes:

1. This mod comes in several parts, some of which can be installed separately. There are more detailed notes about each section below. Most of the sections are optional in game, even if they are installed.
...
4. Much thanks to p_zombie325 for the Russian translation and energisedcamel for the sound files.
...
4) Flying Aerie
    This is a mod for Aerie to get her wings back. There are three paths toward getting her wings back: the Regeneration route, the Edwin route, and the Spell-Store route. All three routes start in SoA and can be pursued simultaneously. They all finish in ToB. Like almost everything we write, you can pick up in ToB where you left off in SoA, so there is no need to stay in SoA in order to finish (or even start) this component. This option is also available for a brand-new ToB game and is complete.

5) Minsc-Neera-Boo Romance (SOA & TOB)
    Something that absolutely no one ever asked for, but you all secretly wanted: an optional romance between Neera, Minsc, and Boo! Written and coded because we can. If you aren't romancing Neera, Minsc will do it instead. This can start in SOA or TOB and is finished, including a wraith scene and epilogues.

6) Dorn-Haer'Dalis Romance (SOA & TOB)
      Another optional romance, because evil people need love too. This romance will begin in either SOA or TOB (continuing into TOB if you start it earlier) and includes a wraith scene, epilogues, an Aerie conflict, and lots of snarky comments on all sides. Not to mention the joy of Haer'Dalis and his florid poetry.

7) Jaheira-Wilson Romance (SoA)
       An optional romance between Jaheira and the secret NPC Wilson, that absolutely no one asked for and we wrote anyway. It will begin in SoA once you have both in your party, as long as the PC isn't romancing Jaheira. If you go to ToB before the romance finishes it will pick up where you left off in ToB. There are additional ToB dialogues provided the SoA part is finished before the Forest of Mir Wraith scene in ToB.

8) Other things in this installation:
- Expanded Mae'Var quest! You now have the option of returning the things you steal from the temples.
- A fix in the Underdark so drow bands won't attack you while you're disguised.
...
- An expansion for the Windspear Hills Quest to make the Order turn on you if you refuse Garren Windspear's help. 
...
Part 2: For the Evil (optional): 
     Additional mod options that may be off-putting to some good players. We write our evil characters as fairly awful people in the main mod and this explores them more in depth. However, this is actually less disruptive than For The Good to a normal game and we quite like how most of it turned out. These additions have nothing to do with Mazzy so you do not need to install them if you are only here for her.

1) Miscellaneous Evil Options For You:
         - An evil player option w/ the dryads in Irenicus' dungeon.
         - Minor evil options w/ Tiiro & Auvala, and Am Si (some of Tiiro and Auvala dialogues might require another mod to be installed).
         - Additional courtesan options in the Bridge District, Docks, & Brynnlaw
         - A more evil option with the dryad in the Windspear Hills
         - More immediate evil options with Adalon in Underdark
...
2) Bodhi NPC- Now a fully functional NPC in SoA and ToB. Should be completely compatible with Ascension's Bodhi (the game treats them as completely different people). All good party members are incompatible with her and will object to her being in your party. She is also the enemy of Drizzt and the Order of the Radiant Heart. To get her in SoA you must work for her in Chapter 3, then defeat her and ask her to join you in Chapter 6. Bodhi is as complete as we're going to make her. She has lots of SoA interjections into the end-game, but not that many banters.
...
5) Sarevok-Viconia Relationship (Romance is too strong a term). 5 additional dialogues that start after their second banter.

6) Expanded Viconia-Hexxat Relationship. Triggers between their normal in-game banters. Four conversations. If you have a banter accelerator enabled, you'll probably need to travel/rest a lot to see them all since their final in-game banter ends the "relationship".

7) Viconia's Peace: A final quest for chapter 6/7 that builds off the Viconia-Clara banters. You must have defeated Bodhi and gotten the last Clara-Viconia NPC banter before this quest becomes available. We do not recommend starting this quest until you have finished everything you need to before the end-game... and that's all we're going to say about that.
...
Part 4: "Do NOT allow duplicate TOB epilogues" component (optional):
      If you install this, AllThingsMazzy epilogues will override the standard TOB epilogues and most mod epilogues. If you do not install this, you will get multiple epilogues where applicable. Either way, the AllThingsMazzy TOB epilogues should always play if triggered. 
      Please note that other mods may still overwrite the standard TOB epilogues regardless of this choice. Additionally, mods installed after ATM may cause duplicate epilogues since ours cannot be turned off the usual way. It's best to install this last if possible.
...
This AllThingsMazzy mega-mod is installed like any other Weidu mod. Unzip it, put the AllThingsMazzy folder and set up file in your main game folder, and then run the set up.
    - We recommend installing the mod after major quest and NPC mods but before your tweaks. This will help crossmod NPC content work properly. While you should be able to install this mod before other mod romances without major issues, after would be better to avoid getting duplicate TOB epilogues.
    - HOWEVER, if you plan to use the NPC Flirtpack or any romance mod that adds Player-Initiated Dialogues for existing NPCs, you should install those after all other banter/romance mods. We've done our best to account for PIDs in Mazzy, but they have a way of breaking other mods that are installed afterwards.
...
AllThingsMazzy should be compatible with most other mods. We've worked hard to make it fool proof since Ratatoskr has a LOT of mods installed. However, we cannot guarantee that our content will mesh with other mods in terms of NPC characterization/personality. We tend to write as though no other mods are installed since there's just too many to keep track of, and in some cases, we take existing NPC's in the opposite direction from what other mods chose to do.

In addition, we have tried to account for the following mods in our code, meaning that our rest scenes don't trigger concurrently and you may see different dialogue if you have those mods installed (for example, Imoen may have a different interjection if you have active romance):
	
1. Friendships/Banters: Viconia Friendship, the IEP Banter Project (as of March 25th, 2017). The other Mazzy Friendship shouldn't break our mod if you have both installed, but they don't mesh well thematically.
...
Version 3.05   ***Spoilers Below***   ***Spoilers Below*** 
...
***This mod is no longer compatible with non-EE Baldur's Gate. Separating everything was getting in the way of our code. If you're really a die hard original Baldur's Gate user, message me and I can send you 1.071. That's the last version that might (and I mean might) work for you.
	...
	Main Mod: 
        	...
        	1. Added a list of mods with crossmod content as a text file for anyone who's curious.
                2. Some minor reorganizing of the setup file.
...
Full Content of All Things Mazzy: Romance, Friendship, and More!  (the Mazzy sections)

A: Mazzy Friendship/Romance: 
         - Mazzy Initiated Friendship Talks at set times/locations during the game (SOA & TOB)
         - Mazzy Romance: Quest to start the romance in SOA (starts after the Underdark) & TOB
...
C. Imoen and Mazzy 
        - A series of friendship/optional romance talks that will play if you take Mazzy to Spellhold. Several alternate talks depending on who CHARNAME decides to romance.
        - Includes 1 talk between Imoen and Viconia
        - Talk sequence will continue/start in TOB if not already done
        - This is made to be fully compatible with the Imoen Romance and will include some extra interjections and dialogues if you are romancing Imoen.

D. Korgan and Mazzy conversations: 4 total (Parts of this series also play in TOB)
	- the 1st when you rest in an inn after their normal in-game banter has occurred. 
	- The 2nd when they're both in your party and able to talk again. 
	- The 3rd conversation takes place several days after that. After this, he won't leave at high rep.
...
M. Two quests with the harlots at the Docks. Talk to a harlot w/ Mazzy in your party. Talk to her again if/when you've destroyed the Shadow Thieves.


For the Good (optional)

N. Hostile Mazzy: (Also in TOB)
	...
	- Mazzy will also attack if you do anything too evil during certain quests

O. Hexxat/Mazzy conflict (both SOA & TOB).
...
P. Additional Mazzy Interjections
...
Version 3.04   ***Spoilers Below***   ***Spoilers Below*** 

Changes: 3.04

	Main Mod: ForTheEvil/Main
		
        	1. Moved two Viconia epilogues from For the Evil to the main mod. They didn't need to be in that section.
		2. Also made minor phrasing edits to 2 of Minsc's epilogues
...
Changes: 3.03
	...
	Main Mod: For the Evil
            1. Corrected a line in Viconia Rules Ust Natha. The code was right, Viconia just had the wrong dialogue.
...
Changes: 3.02
	...
	Main Mod: For the Evil
		1. Fixed glitch w/ evil Dryad option in starting dungeon
...
Changes: 3.01
	...
	Main Mod: All Things Mazzy
        ...
        Main Mod: Clara
                1. Gave Clara an optional soundset. (This will appear as an optional component at the end of the Weidu install and you will need to start a new game for the sounds to appear.)
...
Main Mod: All Things Mazzy:
		1. Went through all of Mazzy's talks and edited them to our satisfaction.
                2. Added multiple recurring talks for the Mazzy romance and friendship.
                3. You can now receive Mazzy's Shadow Thief quest even without the romance. It'll start in Chapter 6 after completing Bodhi's Hideout.
                4. Fixed a glitch involving the Player Thief Guild & Mazzy Romance Quest.
                5. Fixed a glitch in the final Order quest talk
		6. Added 2 new conversations between Mazzy and Lilarcor.
                7. New Mazzy interjections (SOA & TOB)
                8. Fixed glitch w/ TOB romance starting even if already active & some issues with Inn Quest.
               9. Added 5 new breakup talks if you end other romances for Mazzy (SOA/TOB)

	Main Mod: Dorn & Haerdalis
		1. New interjections if romance active (SOA & TOB)
                2. New TOB only talk after Dorn's Quest

	Main Mod: Clara
	       1. New interjections (SOA & TOB)
               2. A second library quest building off the first (starts in chapter 6)

        Main Mod: Flying Aerie
               1. 3 additional NPC Wing response talks.

	Main Mod: Jaheira & Wilson
		1. NPC romance spanning ~26 love talks on a timer and three other talks based on events.
                2. Interjections where appropriate with an active romance

        Main Mod: Misc.
		1. Corrected Terl glitch with final Darkside Anomen talk.
                2. Various other bug and typo corrections.
                3. We've also added some delays to timers to help spread out our talks where possible.
                4. Added 2 more halfling NPC Easter Eggs

	For The Evil: Misc.
		1. Fixed a glitch in Mazzy's house for the evil Clara-Viconia quest
                2. Fixed a walking glitch with Imrae in Viconia Rules Ust Natha and added some animations.
               3. Also added some NPC objections to the evil options in Ust Natha

	For the Good: Mazzy
                1. Fixed a glitch that stopped the Mazzy-Hexxat conflict from triggering in TOB.

	For the Good: Misc
		1. Edited a few lines to account for an active HD-Dorn romance.
...
Changes:
	...
	B. Main Mod: Clara
		1. Fixed an issue with Edwin's belt from their TOB banters. It still won't take effect until you leave inventory just like Clara's (that's due to a workaround that stops the game from crashing), but he will actually be able to use it.
                2. Created an NPC quest involving Clara and Rose Bouquet. The quest proper will begin once Aran is dead.
...
Changes: 
 	...
 	A. Main Mod: Mazzy
            1. Option to end Viconia and Mazzy's conversations in the early dialogues.

	B. Main Mod: Clara
	    1. You can now end Clara and Anomen's romance in the first dialogue.

        C: Main Mod: Flying Aerie
	    1. You can now end Aerie's attempts to regenerate her wings so she'll stop trying. She can still gain wings following one of the other paths.

	D: Main Mod: Minsc and Neera
	    1. You can now turn off their dialogues in the first conversation.
	    2. Minsc will now go to the Hidden Refuge instead of the Copper Coronet if he's romancing Neera.

	E: Main Mod: Misc
	     1. You can now sell Dragomir's Cloak to Bodhi if you're working for her.
	     2. If Dorn gives up his patron, he can pledge service to an evil god at their temple to regain his awesome powers. Check your local evil temple for details.

        F. For the Evil: Things get a little dark.
             1. Option to turn off Hexxat-Korgan's weird friendship in their first dialogue.
...
Changes: 
 	...
 	A. Main Mod: Mazzy
            ...
            2. Final Mazzy-Imoen talk to close out their relationship
...
Changes: 
 	...
 	A. Main Mod: Mazzy
            1. Bug fix: Changed the triggers in Imoen-Mazzy's dialogues to properly account for relationships between Imoen, Mazzy, and/or CharName.
	    2. Added Wilson interjections into Mazzy scenes where every NPC responds.
            3. Additional Jaheira-Mazzy talk if Mazzy romancing CN
            4. A Mazzy-Wilson Banter (SOA/TOB)

	B. Main Mod: Clara
	    1. Added four new Jaheira-Clara banters (2 for SoA/Tob. One that is SoA only. The last one is ToB only.)
	    2. Fixed a bug in Imoen and Clara's 2nd banter where the first line would trigger even if Clara wasn't in your party.
            3. Two more interjections
            4. Added 4 banters with Neera and 3 with Wilson (SOA/TOB)

        C: Main Mod: Flying Aerie
	    1. 4 more Edwin-Aerie talks (3 TOB only) where she can get wings.
            2. Adjusted TOB dialogues to account for her wings
            3. 10 Aerie Talks (9 both SOA/TOB, 3 TOB only talks) as she tries to regain her wings.
            4. 6 NPC talks related to Aerie's wings (SOA & TOB)
            5. Fixed a stuttering bug in the Jaheira-Aerie TOB talk
            6. 6 NPC/CN Talks on the Wizard Wings Path (SOA & TOB)
            7. 2 additional store talks where you can ask about Aerie's wings (SOA)
            8. Find the right wizard, get Aerie's wings (TOB only)
            9. New TOB epilogues if she has wings

	D: Main Mod: Misc
	     1. Extra fun text during the Weidu setup, mostly for our own amusement
             2. Bugfix for TOB ending if Clara isn't in your party.
             3. New TOB Epilogues for Minsc-Neera, Minsc-Aerie as his witch, and many combinations thereof
             4. New banters between Neera & each of the other party wizards (post Clara banters)

        E. For the Evil: Things get a little dark.
             1. If you have items that belonged to Drizzt's Party and the wizard Malchor Harpell tries to take them back, you can fight him for them instead of automatically giving up the items.
	     2. You can now sell the Dawn Ring to the Temple of Talos instead of returning it to the Temple of Lathander. 
             3. 2 new banters between Bodhi and Clara

        F. For the Good: 
             1. Mazzy will no longer join you if the Radiant Heart is hostile.
...
Changes: 
 	...
 	A. Main Mod: Mazzy
            1. Additional Mazzy-Imoen talk to make their romance optional/less sudden. Edited some lines as well to make everything clearer.
...
Changes: 
 	...
 	A. Main Mod: Mazzy
            1. Fixed crash in Friendship talk about Imoen
            2. Extra bonus content with Mazzy's mother for Imoen and female CN romances
  

        B: Main Mod: Misc
	     1. Minsc & Neera: ~22 Talks (because BCaesar is an incorrigible matchmaker)
             2. Neera-Aerie: 1 Talk


       C. For the Evil: Things get a little dark.
             1. Fixed some errors with the .tra files.


       E. Optional: "Do NOT allow duplicate TOB epilogues" component. 
	     - If you install this, AllThingsMazzy epilogues will override the standard TOB epilogues and most mod epilogues. If you do not install this, you will get multiple epilogues where applicable. Either way, the AllThingsMazzy TOB epilogues should always play if triggered.  (This will not stop other mods from turning off the standard epilogues and you may still get duplicates from other mods installed after ATM).
...
Changes:
 	...
 	A. Main Mod: Mazzy
       ...
       C. For the Evil: Things get a little dark.
             1. More immediate evil option with Adalon in the Underdark
...
***This mod is no longer compatible with non-EE Baldur's Gate. Separating everything was getting in the way of our code. If you're really a die hard original Baldur's Gate user, message me and I can send you 1.071. That's the last version that might work for you.
 	...
 	A. Main Mod: Mazzy
            1. Korgan will now stay in your party at any reputation once you get through his Mazzy talks.
            2. Additional Mazzy interjections
            3. Fixed issue with Talos quest. You should be able to make amends no matter when you stole the necklace.
           

        B: Main Mod: Misc
	     1. Additional Clara banters with Anomen, Aerie, Cernd, Minsc, Rasaad, Haer'Dalis and Sarevok.
             2. Various bug fixes and corrections to Anomen romance fix, Yoshimo banters, etc.
             3. Additional Clara interjections
             4. Darkside Anomen:
                    -Anomen no longer objects to Dorn's first quest after he fails his test. This helps you actually keep him in an evil party.


       C. For the Evil: Things get a little dark.
             1. A more evil option with the dryad in the Windspear Hills


       D. For the Good:
	    1. Korgan no longer sides with Mazzy unless you've had their talks.
...
Changes:  
             1. Mazzy-Keldorn additions - he will sponsor her to join the Order of the Radiant Heart.
             2. Fixed glitch with Clara's epilogue and 1st Mazzy/Viconia conversation.
	     3. Other minor corrections and bugfixes
             4. Additions to Sarevok/Viconia if CN is romancing her. Fixed some dialogue as well.

Version 1.046     

Changes:  
         1. Additions to Hexxat's introduction that make the Clara choice more obvious.
         2. ForTheGood/ForTheEvil can't be installed without the main mod.
         3. An additional Clara scene
         4. Minor fixes in the Underdark, Maevar Temple Quest, Getting Clara
         5. Good Party conflict with Hexxat.
         6. A Hexxat-Mazzy conflict (SOA & TOB).
         7. A Korgan-Hexxat friendship. About 7 conversations.
         8. A series of Sarevok-Viconia talks.

Version 1.039

Changes: 
 	1. Keldorn-Mazzy conversation
	2. Minor coding fixes
        3. Additional Viconia/Mazzy banters
        4. A short quest beginning when you talk to a Harlot at the Docks

Version 1.038  

Changes: Compatible with EET and other versions of BG2. 
         Hostile Mazzy works in TOB and accounts for Sarevok
         Some extra banters will also play in TOB if you missed them during SOA
	 You can summon Clara in TOB whether you saved her or not in SOA (She doesn't talk much and has no epilogue yet, but she's there)
         Minor edits and additions to existing interjections
         Clara should be fully compatible with the Bard Stronghold
         Additional banter between Mazzy + Jaheira

Version 1.037

Changes: Fixed Bugs relating to the Good Cleric stronghold quest & Dorn's quest.  
         Playable Clara
         New dialogues and interjections