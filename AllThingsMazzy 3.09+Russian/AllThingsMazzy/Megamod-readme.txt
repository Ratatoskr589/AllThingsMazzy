...
AllThingsMazzy should be compatible with most other mods. We've worked hard to make it foolproof since Ratatoskr has a LOT of mods installed. However, we cannot guarantee that our content will mesh with other mods in terms of NPC characterization/personality. We tend to write as though no other mods are installed since there's just too many to keep track of, and in some cases, we take existing NPC's in the opposite direction from what other mods chose to do.
...
Changes: 
	...
	Main Mod: 
        	...
        	1. Fixed a compatibility issue with the Dorn Romance mod and Dorn's patron quest. Hopefully fixed any solo issues with the patron quest on its own as well.
...
Changes: 
	...
	Main Mod: 
        	...
        	1. Updates and corrections to the Russian version.
